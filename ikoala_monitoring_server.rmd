...
params:
  ...
  study_site: sites/sites_coastal_1.csv
  study_area: Southern Tablelands
...
#all sites not on the grid are removed!!!
if (params$report_type=="monitoring")
{
...
#study for monitoring: all sites within the area (hull)
#study for general: all sites in the database
