...
params:
  ...
  study_periods_name: periods/periods_coastal.csv
  study_periods: periods/periods_coastal.csv
...
*  Study periods file: `r params$study_periods_name`
...
if (params$study_periods==params$study_periods_name) defperiods <- read.csv(params$study_periods) else defperiods <- params$study_periods
...
if (params$restricted=="region") cat(paste0("\n As restricted is switched to **region**, the detailed report is based on sites defined by the entry:", defperiods$region[1]," in the periods file (",params$study_periods_name,").\n "))
